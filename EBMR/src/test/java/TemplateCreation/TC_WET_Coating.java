...
public class TC_WET_Coating extends Mainpageclass {
	@Test
	...
	for (int j=2;j<=2;j++) {
		...
		driver.findElement(By.xpath("(//*[contains (text(),' Coating')])[2]")).click();Thread.sleep(2000);
...
//		scrollpageup();
		...
		driver.findElement(By.xpath("(//*[@type='text'])[31]")).sendKeys(Frequnency);Thread.sleep(2000);
		...
		driver.findElement(By.xpath("(//*[@class='fa fa-angle-down float-right'])[10]")).click();Thread.sleep(2000);
