...
public class TC_H_QA_Released_CancelInitiate extends Mainpageclass {
	...
	public  void A() throws Exception {
		...
		driver.findElement(By.xpath("//*[contains (text(),'Cancel Initiate')]")).click();Thread.sleep(2000);
		System.out.println("user clicked  cancel Initiate");
