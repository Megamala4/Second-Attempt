...
public class TC_E_PD_Initiated_Obselete extends Mainpageclass {
	...
	public void A() throws Exception{
		...
		driver.findElement(By.xpath("//*[contains (text(),'Obsolete Initiate')]")).sendKeys();Thread.sleep(2000);
		System.out.println("user clicked  obselete");
	}
