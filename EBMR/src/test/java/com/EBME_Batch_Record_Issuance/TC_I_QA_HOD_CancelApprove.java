...
public class TC_I_QA_HOD_CancelApprove extends Mainpageclass {
	...
	driver.findElement(By.xpath("//*[contains (text(),'Cancel Approve')]")).click();Thread.sleep(2000);
	System.out.println("user clicked  Cancel Approver");
	}
