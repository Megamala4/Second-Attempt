...
public class TC_1_DG_Initiator_Initiate extends Mainpageclass {
	...
	public void A() throws Exception {
...

		{
			...
			System.out.println("User Clicked wG ");
			...
			driver.findElement(By.xpath("//*[@formcontrolname='shelfLife_Id']")).sendKeys(shelf);Thread.sleep(2000);
