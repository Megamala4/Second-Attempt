...
public class TC_2_WG_BatchFormula_ReInitiate extends Mainpageclass {
	...
	public void A() throws Exception{
		...
		for (int i=4;i <=4; i++)
		{
			String Blending = xls.getCellData("Batch Formula", "ADDBlending", i);
			...
			driver.findElement(By.xpath("(//*[@class='form-control ng-untouched ng-pristine ng-valid'])[9]")).sendKeys(Blending);Thread.sleep(2000);
