...
public class TC_1_DG_Initiator_ProcessInstruction_ReInitiate extends Mainpageclass {
	...
	public void A() throws Exception {
...

		{
			...
			driver.findElement(By.xpath("(// *[contains (text(),'Add')])[4]")).click();Thread.sleep(2000);
