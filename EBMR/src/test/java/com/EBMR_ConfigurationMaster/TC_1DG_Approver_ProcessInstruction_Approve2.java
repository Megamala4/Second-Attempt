...
public class TC_1DG_Approver_ProcessInstruction_Approve2 extends Mainpageclass {
	...
	public void A() throws Exception {
...

		{
			...
			String Name = xls.getCellData("Process Instruction", "search ",i);
				...
				driver.findElement(By.xpath("//*[@type='search']")).sendKeys(Name);
