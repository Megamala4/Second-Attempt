...
public class TC_2_WG_Initiator_Checklist_ReInitiate extends Mainpageclass {
	...
	public void A() throws Exception {
		...
		{
			String addcheck = xls.getCellData("ckecklist", "addcheckPoints ",i);
			...
			driver.findElement(By.xpath("//*[@formcontrolname='checklistPoints']")).sendKeys(addcheck);
			Thread.sleep(2000);			
