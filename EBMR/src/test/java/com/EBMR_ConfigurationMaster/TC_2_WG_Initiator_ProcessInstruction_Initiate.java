...
public class TC_2_WG_Initiator_ProcessInstruction_Initiate extends Mainpageclass {
...
@Test
...

	{
		...
		driver.findElement(By.xpath("//*[@formcontrolname='processInstructionsTitle']")).sendKeys(processtitle);Thread.sleep(2000);
		...
		driver.findElement(By.xpath("//*[@formcontrolname='processInstructionSubPoint']")).sendKeys(points);Thread.sleep(2000);
