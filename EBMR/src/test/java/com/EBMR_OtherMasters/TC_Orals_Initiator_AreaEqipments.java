...
public class TC_Orals_Initiator_AreaEqipments extends Mainpageclass {
	@Test
	...
	public void A() throws Exception{
		...
		{
			//DataMapping 
			 String Areadropdown = xls.getCellData("AreaEuipment","Arearoom" , i);
			 String DropdownSelection = xls.getCellData("AreaEuipment", "DropdownSelection", i);
			...
			driver.findElement(By.xpath("//*[@formcontrolname='areaRoomNumber_Id']")).sendKeys(Areadropdown);Thread.sleep(2000);
			...
			driver.findElement(By.xpath("//button[@formcontrolname='capacitySize']")).clear();Thread.sleep(2000);
