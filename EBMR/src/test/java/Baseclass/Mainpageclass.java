...
//	public static Xls_Reader xls = new Xls_Reader("C:\\Users\\megamala.burra\\eclipse-workspace\\EBMR\\src\\test\\resources\\Excel\\login.xlsx");
    ...
    public static void SYPSO(String pin,String passwordpin  ) throws Exception{
     	...
     	driver.findElement(By.xpath("//button[contains (text(),'Submit')]")).click();Thread.sleep(2000);Thread.sleep(2000);
        try {
			driver.findElement(By.xpath("(//button[contains (text(),'No')])[3]")).click();Thread.sleep(2000);
		} catch (Exception e2) {
			e2.printStackTrace();	
        ...
        try {
			driver.findElement(By.xpath("(//button[contains (text(),'No')])[8]")).click();Thread.sleep(2000);
		} catch (Exception e2) {
			
			e2.printStackTrace();
		}
        try {
			driver.findElement(By.xpath("(//*[contains (text(),'No')])[92]")).click();Thread.sleep(2000);
		} catch (Exception e3) {
			e3.printStackTrace();
		}
	   ...
	   driver.findElement(By.xpath("//button[contains (text(),'OK')]")).click();Thread.sleep(2000);
		...
		try {
			driver.findElement(By.xpath("(//*[@class='close'])[4]")).click();Thread.sleep(2000);
		} catch (Exception e2) {
			e2.printStackTrace();
		}
		try {
			driver.findElement(By.xpath("(//*[@class='close'])[5]")).click();Thread.sleep(2000);
		} catch (Exception e2) {
			e2.printStackTrace();
		}
		try {
			driver.findElement(By.xpath("(//*[@class='close'])[6]")).click();Thread.sleep(2000);
		} catch (Exception e2) {
			e2.printStackTrace();
		}
	   try {
   ...
   public static void UploadFile(String path) throws Exception
{
   ...
   public static void SYO(String pin,String Password  ) throws Exception{
       ...
       try {
			driver.findElement(By.xpath("(//*[contains (text(),'No')])[106]")).click();Thread.sleep(2000);
		} catch (Exception e3) {
			e3.printStackTrace();
		}
       try {
			driver.findElement(By.xpath("(//*[contains (text(),'No')])[158]")).click();Thread.sleep(2000);
		} catch (Exception e3) {
			e3.printStackTrace();
		}
   ...
   public static void AYS() throws Exception
   {    	
   		for (int i=2;i <=2; i++)
   		{
   		String password = xls.getCellData("Credentials","PasswordApprover",i);
   ...
   public static void RYS() throws Exception{
   ...
   //Review Buttion
   public static void RYPSO(String pin,String Password ) throws Exception{
	   
	   driver.findElement(By.xpath("//a[normalize-space()='Review']")).click();Thread.sleep(2000);
	   try {
			driver.findElement(By.xpath("(//button[contains (text(),'No')])[3]")).click();Thread.sleep(2000);
		} catch (Exception e2) {
			e2.printStackTrace();
